    ...
    <>
      ...
      <div className='topbar_body'>
        <div style={{width: '100%',}} className="row">
          ...
          <Badge  className='bg-light text-dark' style={{padding: '12px', fontSize: '16px', marginLeft: '20px', fontFamily: 'monospace'}}>Welcome to Affotax CRM | {user}</Badge>

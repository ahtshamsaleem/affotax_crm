...
function Timer(props) {
  ...
  const handleChange = (name, option) => {
    ...
    if (name === "clientName") {
      ...
      filteredArray = filteredArray.filter(
        (obj) => obj.client_id && option.value === obj.client_id
      );
  ...
  if (timerOn && window.location.pathname !== "/clients/job-planning") {
            ...
            <div className="col-9">
              ...
              >
                <Select
                  ...
                  options={clients}
                  onChange={(option) => {
                    handleChange("clientName", option);
                  }}
                ...
                <Select
                  ...
                  onChange={(option) => {
                    handleChange("departmentName", option);
                  }}
                />
                ...
                <div className="button-container">
                  {timerOn ? (
                    <button
                      type="submit"
                      disabled={loader}
                      className={`stop-button ${timerOn ? "on" : "off"}`}
                    >
                      {" "}
                      {loader ? (
                        <img
                    ...
                    <button
                      type="submit"
                      disabled={loader}
                      className={`start-button ${timerOn ? "on" : "off"}`}
                    >
                      {loader ? (
                        <img
                          style={{ height: "25px" }}

...
export default function JobPlanning(props) {
  ...
  const [statusFvalue, setStatusFvalue] = useState(
    state ? state.filterType : null
  );
  const [departmentFvalue, setDepartmentFvalue] = useState(
    state ? state.departmentName : null
  );
...
const cancelNotesModalHandler = () => {
  setShowNotesModal(false);

}


const submitNotesModalHandler = async () => {
  ...
  const filter = async () => {
    ...
    if (filteredArray !== undefined) {
      filteredArray = await filteredArray.filter(
        (obj) => obj.client_id && obj.client_id.isActive === true
      );
    }
      ...
      for (var arr of filteredArray) {
        ...
        if (arr.job_name === "Bookkeeping") {
          if (
            ...
            (deadline.setHours(0, 0, 0, 0) < today.setHours(0, 0, 0, 0) &&
              yearEnd.setHours(0, 0, 0, 0) < today.setHours(0, 0, 0, 0))
          ) {
    ...
    if (filteredArray) {
      if (filteredArray !== undefined) {
        filteredArray = await filteredArray.filter(
          (obj) => obj.job_name && obj.job_name !== "Billing"
        );
      }
    }
    ...
    if (
      ...
      filteredArray = await filteredArray.filter(
        (obj) => obj.client_id && obj.client_id.source === sourceFValue
      );
    }
    ...
    if (
      ...
      filteredArray = await filteredArray.filter(
        (obj) => obj.client_id && obj.client_id.partner === partnerFValue
      );
    }
    ...
    if (
      ...
      filteredArray = await filteredArray.filter(
        (obj) => obj.job_status && obj.job_status === jStatusFvalue
      );
    }
    ...
    if (
      ...
      filteredArray = await filteredArray.filter(
        (obj) => obj.manager_id && obj.manager_id.name === cManagerFvalue
      );
    }
      ...
      filteredArray = await filteredArray.filter((obj) => {
        if (obj.job_deadline && obj.year_end) {
          ...
          if (
            ...
            if (statusFvalue === "Overdue") return obj;
          } else if (
            deadline.setHours(0, 0, 0, 0) < today.setHours(0, 0, 0, 0)
          ) {
            if (statusFvalue === "Overdue") return obj;
            ...
            if (statusFvalue === "Due") return obj;
          } else if (
            deadline.setHours(0, 0, 0, 0) === today.setHours(0, 0, 0, 0)
          ) {
            if (statusFvalue === "Due") return obj;
    ...
    if (
      filteredArray !== undefined &&
      companyNameFromUrl !== null &&
      companyNameFromUrl !== ""
    ) {
      filteredArray = await filteredArray.filter(
        (obj) =>
          obj.client_id && obj.client_id.company_name === companyNameFromUrl
      );
    }
    ...
    if (
      ...
      filteredArray = await filteredArray.filter(
        (obj) => obj._id && obj._id === jobIdFromUrl
      );
    }
    ...
    if (
      filteredArray !== undefined &&
      departmentFvalue !== null &&
      departmentFvalue !== ""
    ) {
      filteredArray = await filteredArray.filter(
        (obj) => obj.job_name && obj.job_name === departmentFvalue
      );
    }
    ...
    if (
      ...
      filteredArray = await filteredArray.filter(
        (obj) => obj.job_holder_id && obj.job_holder_id.name === jHolderFvalue
      );
    }
    ...
    if (
      filteredArray !== undefined &&
      subscriptionFvalue !== null &&
      subscriptionFvalue !== ""
    ) {
      filteredArray = await filteredArray.filter(
        (obj) => obj.subscription && obj.subscription === subscriptionFvalue
      );
    }
    ...
    if (yearEndFvalue) {
      ...
      if (
        ...
        filteredArray = await filteredArray.filter((obj) => {
          ...
          if (obj.year_end && obj.year_end !== "Invalid Date") {
            if (
              deadline.setHours(0, 0, 0, 0) === tomorrow.setHours(0, 0, 0, 0)
            ) {
              return obj;
            }
          }
      ...
      if (
        ...
        yearEndFvalue !== null &&
        yearEndFvalue !== "" &&
        yearEndFvalue === "In 7 days"
      ) {
        filteredArray = await filteredArray.filter((obj) => {
          // obj.manager_id && obj.manager_id.name === cManagerFvalue
          const today = new Date();
          const deadline = new Date(obj.year_end);
          const deadlineNextSevenDays = new Date(
            today.getTime() + 7 * 24 * 60 * 60 * 1000
          );
          if (obj.year_end && obj.year_end !== "Invalid Date") {
            if (
              deadline >= today.setHours(0, 0, 0, 0) &&
              deadline <= deadlineNextSevenDays.setHours(0, 0, 0, 0)
            ) {
              return obj;
            }
          }
      ...
      if (
        ...
        filteredArray = await filteredArray.filter((obj) => {
          ...
          if (
            cellDate &&
            cellDate !== "Invalid Date" &&
            filterDate !== "Invalid Date"
          ) {
            // compare dates
            if (
              cellDate.setHours(0, 0, 0, 0) <= filterDate.setHours(0, 0, 0, 0)
            ) {
              return 1; //exclude
            } else if (
              cellDate.setHours(0, 0, 0, 0) > filterDate.setHours(0, 0, 0, 0)
    ...
    if (jobDateFvalue) {
      ...
      if (
        ...
        jobDateFvalue !== null &&
        jobDateFvalue !== "" &&
        jobDateFvalue === "Custom"
      ) {
        filteredArray = await filteredArray.filter((obj) => {
          var cellDate =
            obj.work_deadline !== "" && new Date(obj.work_deadline);
  ...
  useEffect(() => {
    ...
    if (filterFromMyList) {
      setJHolderFvalue(filterFromMyList.jobHolder);
      setDeadlineFvalue(filterFromMyList.deadline);
    }
    filter();
  }, [
    filterFromMyList,
  ...
  //   // let jobsArray = mainrowData

  //   //  let runningTimerJob = jobsArray.find((el) => el._id === clientId)
  
  //   //  jobsArray.splice(0,0, runningTimerJob);
  ...
  // useEffect(() => {
  //   const csId = localStorage.getItem("clientId");
  //   if (csId) {
  //     setClientId(csId);
  //   }
  //   console.log(csId);
  ...
  const getData = async (timeAttempt) => {
    try {
      ...
      // logic to have the running timer at top!



      // client id can be set in the starting state

      //  console.log(response.data)

      //   let jobsArray = response.data;
      ...
      if (timeAttempt === "first") {
        Promise.all([getPreData(), handleColHideOnStart()]);
      }
    } catch (err) {
      console.log(err);
    }
  ...
  //     },
  //   });
  //   console.log('the state of time is ', state)
  //   setTimerState(state.data);
  //   setUser(state.data.user);
  //   // setClients(
  //   //   state.data.clients.map((names) => {
  ...
  useEffect(() => {
    ...
    if (timerOn) {
      ...
      interval = setInterval(() => {
        ...
        let showTime = formatTime(timeSpend)
        //let timeHtml = `<p>${showTime}</p>`
        if(timeRef.current) {
          timeRef.current.innerText = showTime;
        }
...
const ReactTimerComponent = (params) => {
  //console.log("Timer:", params);


  // if (timerOn && clientId === params.data._id) {
 ...
 return (
   <div className="" style={{  width: '100%', height:'100%', marginLeft: ".3rem",}}>
     <form style={{ width: "100%", height:'100%'  }} onSubmit={(e) => e.preventDefault()}>
       ...
       >
         {timerOn && clientId === params.data._id && (
           <p
             style={{
               fontSize: "14px",
               fontWeight: "600",
         ...
         <div className="" style={{
           ...
           {timerOn && clientId === params.data._id ? (
             <button disabled={loading} type="submit" style={{backgroundColor: 'transparent', border: 'none' }}>

               <FaStopCircle 
               
               
               // className={`stop-button ${
               //   clientId === params.data._id
               //     ? timerOn
               //       ? "on"
               //       : "off"
               //     : ""
               ...
               onClick={() => {
                 //setCid(params.data.client_id._id);
                 //setJobName(params.data.job_name);

                 // setNotes(params.data.notes);
                 
                 
                 //localStorage.setItem("clientId", params.data._id);
                 // setNewNotes(params.data.notes)
                 setShowNotesModal(true);
                 //handleStart({notes: params.data.notes});
               }}
             />
             ...
             <button disabled={timerOn} type="submit" style={{backgroundColor: 'transparent', border: 'none' }}>
               ...
               onClick={() => {
                 ...
                 localStorage.setItem("client_id", params.data._id);
                 handleStart({cid: params.data.client_id._id, jobName: params.data.job_name, jobId: params.data._id});
               }}
             />
  ...
  const handleStart = async (dataObject) => {

    const curTime = new Date();
    

    if (!timerOn && dataObject.jobId) {
      const {cid, jobName, jobId} = dataObject;

      if (!cid) {
        return alert("Client_id is required!");
      }
      const formData = {
        message: 'running',
        startTime: curTime,
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          Store.addNotification({ title: "Failed", message: "Could Not Start Timer, Please Try Again", type: "danger", insert: "top", container: "top-right", animationIn: ["animate__animated", "animate__fadeIn"], animationOut: ["animate__animated", "animate__fadeOut"], dismiss: { duration: 5000, onScreen: true, }, });
        }
      } catch (err) {
        Store.addNotification({
          title: "Failed",
      ...
      try {
        ...
        console.log('into the catch block of handle start fucntion')
        Store.addNotification({
          title: "Failed",
          message: "Could Not Stop Timer, Please Try Again",
          type: "danger",
  ...
  if (timerOn) {
    document.title = formatTime(time) + " | " + 'Affotax';
  } else {
    document.title = "Affotax";
  }
  ...
  var columnDefs = [
    ...
    
    {
      ...
      flex: 1.5,
      valueGetter: (p) => {
        return p.data.job_holder_id !== null
          ? p.data.job_holder_id.name
          : p.data.job_holder_name; //to get value from obj inside obj
      },
    ...
    },
    {
      ...
      flex: 1.5,
      valueGetter: (p) => {
        return p.data.manager_id !== null
          ? p.data.manager_id.name
          : p.data.manager_id_name; //to get value from obj inside obj
      },
      cellEditor: "agSelectCellEditor",
      cellEditorParams: {
        values: preData.map((option) => option.label),
    ...
    },
    {
      ...
      cellRendererFramework: (p) => (
        <div>
          <a
            target="_blank"
            href={`/tickets?company_name=${p.data.client_id.company_name}&client_name=${p.data.client_id.client_name}`}
            className=""
            rel="noreferrer"
          >
            {" "}
  ...
  if (roleName === "Admin" || userName === "Ehsan") {
    const obj = {
      headerName: "Source",
      field: "source",
      flex: 1,
  ...
  const onCellValueChanged = useCallback(
    (event) => {
      if (event.colDef.field === "jHolder") {
        const selectedOption = preData.find(
          (option) => option.label === event.data.jHolder
        );
        event.data.jHolder = selectedOption ? selectedOption.value : "";
        event.data.job_holder_id
          ? (event.data.job_holder_id.name = selectedOption
              ? selectedOption.label
              : "")
          : (event.data.job_holder_name =
      ...
      if (event.colDef.field === "cManager") {
        const selectedOption = preData.find(
          (option) => option.label === event.data.cManager
        );
        event.data.cManager = selectedOption ? selectedOption.value : "";
        event.data.manager_id
          ? (event.data.manager_id.name = selectedOption
              ? selectedOption.label
              : "")
          : (event.data.manager_id_name =
              selectedOption && selectedOption.label !== "Select"
                ? selectedOption.label
                : "");
      }
  ...
  const exportToExcel = (e) => {
    ...
    const exportData = [
      columnDefs.map((columnDef) => columnDef.userProvidedColDef.headerName),
    ];
    ...
    XLSX.writeFile(
      workbook,
      `Jobplanning - ${new Date().toISOString().slice(0, 10)}.xlsx`
    );
  };
  ...
  const exportToPdf = () => {
    ...
    const columnDefs = gridApi.columnApi.getAllDisplayedColumns();
    const headerData = columnDefs.map(
      (columnDef) => columnDef.userProvidedColDef.headerName
    );
  ...
  if (loader) {
    ...
    return (
      <>
        ...
        >
          ...
          >
            <div style={{ alignItems: "center" }} className="d-flex">
              <div>
                <h4 style={{ padding: "20px 16px" }}>Job Planning</h4>
              </div>
              ...
              <div className="table-col-numbers mx-2">
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    setDepartmentSummaryToggle(!departmentSummaryToggle);
                  }}
                  className="form-control"
                >
                  <svg
              ...
              <div className="table-col-numbers mx-2">
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    setMultipleRowEditToggle(!multipleRowEditToggle);
                  }}
                  className="form-control"
                >
                  <svg
                ...
                <div className="dropdown">
                  ...
                  >
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      className="feather feather-eye-off icon-16"
                    >
                      ...
                      <div className="col-6">
                        <ul style={{ all: "unset" }}>
                          <li>
                            <button
                              onClick={(e) => {
                                toggleColHandler(e, "vat_login");
                              }}
                              className={`dropdown-item ${
                                !colVisibility.vat_login ? "" : "active"
                              }`}
                            >
                              Vat Login
                            </button>
                          ...
                          <li>
                            <button
                              onClick={(e) => {
                                toggleColHandler(e, "payee_login");
                              }}
                              className={`dropdown-item ${
                                !colVisibility.payee_login ? "" : "active"
                              }`}
                            >
                              PAYEE Login
                            </button>
                          ...
                          <li>
                            <button
                              onClick={(e) => {
                                toggleColHandler(e, "ct_login");
                              }}
                              className={`dropdown-item ${
                                !colVisibility.ct_login ? "" : "active"
                              }`}
                            >
                              CT Login
                            </button>
                          ...
                          <li>
                            <button
                              onClick={(e) => {
                                toggleColHandler(e, "tr_login");
                              }}
                              className={`dropdown-item ${
                                !colVisibility.tr_login ? "" : "active"
                              }`}
                            >
                              TR Login
                            </button>
                          ...
                          <li>
                            <button
                              onClick={(e) => {
                                toggleColHandler(e, "utr");
                              }}
                              className={`dropdown-item ${
                                !colVisibility.utr ? "" : "active"
                              }`}
                            >
                              UTR
                            </button>
                          ...
                          <li>
                            <button
                              onClick={(e) => {
                                toggleColHandler(e, "auth_code");
                              }}
                              className={`dropdown-item ${
                                !colVisibility.auth_code ? "" : "active"
                              }`}
                            >
                              Auth Code
                            </button>
                          ...
                          {roleName === "Admin" && (
                            <>
                              <li>
                                <button
                                  onClick={(e) => {
                                    toggleColHandler(e, "cManager");
                                  }}
                                  className={`dropdown-item ${
                                    !colVisibility.cManager ? "" : "active"
                                  }`}
                                >
                                  Lead
                                </button>
                              ...
                              <li>
                                <button
                                  onClick={(e) => {
                                    toggleColHandler(e, "fee");
                                  }}
                                  className={`dropdown-item ${
                                    !colVisibility.fee ? "" : "active"
                                  }`}
                                >
                                  Fee
                                </button>
                              ...
                              <li>
                                <button
                                  onClick={(e) => {
                                    toggleColHandler(e, "subscription");
                                  }}
                                  className={`dropdown-item ${
                                    !colVisibility.subscription ? "" : "active"
                                  }`}
                                >
                                  Subscription
                                </button>
                              ...
                              <li>
                                <button
                                  onClick={(e) => {
                                    toggleColHandler(e, "email");
                                  }}
                                  className={`dropdown-item ${
                                    !colVisibility.email ? "" : "active"
                                  }`}
                                >
                                  Email
                                </button>
                              ...
                              <li>
                                <button
                                  onClick={(e) => {
                                    toggleColHandler(e, "phone");
                                  }}
                                  className={`dropdown-item ${
                                    !colVisibility.phone ? "" : "active"
                                  }`}
                                >
                                  Phone
                                </button>
                              ...
                              <li>
                                <button
                                  onClick={(e) => {
                                    toggleColHandler(e, "country");
                                  }}
                                  className={`dropdown-item ${
                                    !colVisibility.country ? "" : "active"
                                  }`}
                                >
                                  Country
                                </button>
                              ...
                              <li>
                                <button
                                  onClick={(e) => {
                                    toggleColHandler(e, "ticket");
                                  }}
                                  className={`dropdown-item ${
                                    !colVisibility.ticket ? "" : "active"
                                  }`}
                                >
                                  Ticket
                                </button>
                        ...
                        <div className="col-6">
                          <ul style={{ all: "unset" }}>
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "comName");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.comName ? "" : "active"
                                }`}
                              >
                                Company Name
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "cliName");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.cliName ? "" : "active"
                                }`}
                              >
                                Client Name
                              </button>
                            ...
                            {roleName === "Admin" && (
                              <>
                                <li>
                                  <button
                                    onClick={(e) => {
                                      toggleColHandler(e, "source");
                                    }}
                                    className={`dropdown-item ${
                                      !colVisibility.source ? "" : "active"
                                    }`}
                                  >
                                    Source
                                  </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "partner");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.partner ? "" : "active"
                                }`}
                              >
                                Partner
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "jHolder");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.jHolder ? "" : "active"
                                }`}
                              >
                                J.Holder
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "job_name");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.job_name ? "" : "active"
                                }`}
                              >
                                Department
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "hours");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.hours ? "" : "active"
                                }`}
                              >
                                Hours
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "year_end");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.year_end ? "" : "active"
                                }`}
                              >
                                Year End
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "job_deadline");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.job_deadline ? "" : "active"
                                }`}
                              >
                                Deadline
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "work_deadline");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.work_deadline ? "" : "active"
                                }`}
                              >
                                Date
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "stat");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.stat ? "" : "active"
                                }`}
                              >
                                Status
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "notes");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.notes ? "" : "active"
                                }`}
                              >
                                Note
                              </button>
                            ...
                            <li>
                              <button
                                onClick={(e) => {
                                  toggleColHandler(e, "job_status");
                                }}
                                className={`dropdown-item ${
                                  !colVisibility.job_status ? "" : "active"
                                }`}
                              >
                                J.Status
                              </button>
                              ...
                              return (
                                <li>
                                  <button
                                    onClick={(e) => {
                                      e.preventDefault();
                                      navigate("/finance/charts_of_accounts");
                                    }}
                                    className={`dropdown-item ${
                                      location.pathname ===
                                      "/finance/charts_of_accounts"
                                        ? "active"
                                        : ""
                                    }`}
                                  >
          ...
          <div
            className={`multipleRowEdit ${
              multipleRowEditToggle ? "open" : "closed"
            } `}
          >
            <hr
              style={{ marginBottom: "0.1rem", color: "rgb(131, 131, 131)" }}
            />
          ...
          <div
            className={`departmentSummary ${
              departmentSummaryToggle ? "open" : "closed"
            } `}
          >
            <hr
              style={{ marginBottom: "0.1rem", color: "rgb(131, 131, 131)" }}
              ...
              <div>
                ...
                <div className="row">
                  <div className="col-6">
                    <div className="row">
                      <div className="col-3">
                        <p className="mb-1">Bookkeeping</p>
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Bookkeeping", "Overdue");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.bookkeepingOverDue}
                            </span>{" "}
                            Overdue
                          </p>
                        </Link>
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Bookkeeping", "Due");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.bookkeepingDue}
                            </span>{" "}
                            Due
                          </p>
                        </Link>
                      ...
                      <div className="col-3">
                        <p className="mb-1">Payroll</p>

                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Payroll", "Overdue");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.PayrollOverDue}
                            </span>{" "}
                            Overdue
                          </p>
                        </Link>
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Payroll", "Due");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.PayrollDue}
                            </span>{" "}
                            Due
                          </p>
                        </Link>
                      ...
                      <div className="col-3">
                        <p className="mb-1">Vat Return</p>

                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Vat Return", "Overdue");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.vatreturnOverDue}
                            </span>{" "}
                            Overdue
                          </p>
                        </Link>
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Vat Return", "Due");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.vatreturnDue}
                            </span>{" "}
                            Due
                          </p>
                        </Link>
                      ...
                      <div className="col-3">
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Accounts", "Overdue");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.accountsOverDue}
                            </span>{" "}
                            Overdue
                          </p>
                        </Link>
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Accounts", "Due");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.accountsDue}
                            </span>{" "}
                            Due
                          </p>
                        </Link>
                  ...
                  <div className="col-6">
                    <div className="row">
                      <div className="col-3">
                        <p className="mb-1">Personal Tax</p>

                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet(
                              "Personal Tax",
                              "Overdue"
                            );
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.personaltaxOverDue}
                            </span>{" "}
                            Overdue
                          </p>
                        </Link>
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Personal Tax", "Due");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.personaltaxDue}
                            </span>{" "}
                            Due
                          </p>
                        </Link>
                      ...
                      <div className="col-3">
                        <p className="mb-1">Company Sec</p>

                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Company Sec", "Overdue");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.companysecOverDue}
                            </span>{" "}
                            Overdue
                          </p>
                        </Link>
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Company Sec", "Due");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.companysecDue}
                            </span>{" "}
                            Due
                          </p>
                        </Link>
                      ...
                      <div className="col-3">
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Address", "Overdue");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.addressOverDue}
                            </span>{" "}
                            Overdue
                          </p>
                        </Link>
                        ...
                        <Link
                          style={{ textDecoration: "none" }}
                          onClick={() => {
                            handleDepartmentFilterSet("Address", "Due");
                          }}
                        >
                          <p>
                            <span style={{ fontWeight: "700" }}>
                              {departmentSummaryValue.addressDue}
                            </span>{" "}
                            Due
                          </p>
                        </Link>
          ...
          <div>
            ...
            <div className="ag-theme-alpine" style={{ height: "81vh" }}>
              ...
              <div className="fixed-row">
                <div className="fixed-row-cell">
                  Total Hours: {sumOfMarks.toFixed(1)}
                </div>
        ...
        {showNotesModal ? <NotesModal notesLoader={notesLoader} show={showNotesModal} newNotes={newNotes} submitNotesModalHandler={submitNotesModalHandler}  cancelNotesModalHandler={cancelNotesModalHandler} notesChangeHandler={notesChangeHandler} /> : null}
